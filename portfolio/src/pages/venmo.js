...
const IndexPage = () => (
  <Layout>
    ...
    <div class="ProjectContent">
    	...
    	/>
    	<div class="full-width-image">
    		<img src={require('../images/affinity.jpg')} />
    	</div>
    	...
    	/>
   		<div class="full-width-image">
    		<img id="shadow" src={require('../images/fintech.png')} />
    	</div>
    	...
    	/>
   		<div class="full-width-image">
    		<img src={require('../images/excel.png')} />
    	</div>
    	...
    	/>
   		<div class="full-width-image">
    		<img id="shadow" src={require('../images/graph.png')} />
    	</div>
