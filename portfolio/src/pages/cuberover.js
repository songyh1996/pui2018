...
const IndexPage = () => (
  <Layout>
    <ProjectHero 
      ...
      description="Creating a user interface for the tele-operation control of the CubeRover. Expected to launch to the Moon in 2020 in collaboration with Astrobotic and NASA using Astrobotic’s Peregrine Lander."
    />
